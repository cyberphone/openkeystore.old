 ...
 *
 */
package org.webpki.android.asn1;
        ...
        switch(tagClass)
          {
            ...
            //System.out.println("EOC");
                  ...
                  case BOOLEAN:               return new ASN1Boolean(this);
                  case INTEGER:               return new ASN1Integer(this);
                  case BITSTRING:             return new ASN1BitString(this);
                  case OCTETSTRING:           return new ASN1OctetString(this);
                  case NULL:                  return new ASN1Null(this);
                  case OID:                   return new ASN1ObjectID(this);
                  //case OBJDESCRIPTOR:
                  //case EXTERNAL:
                  //case REAL:
                  case ENUMERATED:            return new ASN1Enumerated (this);
                  //case EMBEDDED_PDV:
                  case UTF8STRING:            return new ASN1UTF8String(this);
                  case SEQUENCE:              return new ASN1Sequence(this);
                  case SET:                   return new ASN1Set(this);
                  case NUMERICSTRING:         return new ASN1NumericString(this);
                  case PRINTABLESTRING:       return new ASN1PrintableString(this);
                  case T61STRING:             return new ASN1T61String(this);
                  //case VIDEOTEXSTRING:
                  case IA5STRING:             return new ASN1IA5String(this);
                  case UTCTIME:               return new ASN1UTCTime(this);
                  case GENERALIZEDTIME:       return new ASN1GeneralizedTime(this);
                  case GRAPHICSTRING:         return new ASN1GraphicString(this);
                  case VISIBLESTRING:         return new ASN1VisibleString(this);
                  case GENERALSTRING:         return new ASN1GeneralString(this);
                  //case UNIVERSALSTRING:
                  case BMPSTRING:             return new ASN1BMPString(this);
                  default: throw new IOException("********** Unknown/unsupported tag 0x" + ArrayUtil.toHexString(tagNumber, (char)0) + " [" + length + "] **********");
                }
            default:
