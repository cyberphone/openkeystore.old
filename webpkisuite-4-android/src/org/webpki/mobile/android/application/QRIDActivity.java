 ...
 */
public final class QRIDActivity extends Activity implements SurfaceHolder.Callback {

  private static final String TAG = QRIDActivity.class.getSimpleName();
...
//    window.addFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON);
  ...
  protected void onResume() {
    ...
    helpTextView = (TextView) findViewById(R.id.qrid_help_text);
  ...
  private void resetStatusView() {
    helpTextView.setText(R.string.msg_default_status);
