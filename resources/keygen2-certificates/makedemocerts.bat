...
java -cp \webpki.org\library\dist\webpki.org-libext-1.00.jar;\webpki.org\resources\third-party-jars\bcprov-jdk16-145.jar org.webpki.ca.CommandLineCA -ca/addpath all -ca/keypass testing -ca/storepass testing -ca/keystore subca.jks -entity/ee -subject "CN=example.com,O=Example Organization,C=US" -validity/start 2012-01-01T00:00:00 -validity/end 2020-07-10T09:59:59 -out/keystore example.jks -out/storepass testing -out/keypass testing  -sigalg RSA_SHA256 -ecccurve P_256
...
java -cp \webpki.org\library\dist\webpki.org-libext-1.00.jar;\webpki.org\resources\third-party-jars\bcprov-jdk16-145.jar org.webpki.ca.CommandLineCA -ca/addpath 1 -ca/keypass testing -ca/storepass testing -ca/keystore subca.jks -entity/ee -subject "CN=Marion Anderson, SERIALNUMBER=19750710-1518" -validity/start 2012-01-01T00:00:00 -validity/end 2020-07-10T09:59:59 -out/keystore marion.jks -out/storepass testing -out/keypass testing  -sigalg RSA_SHA256 -ecccurve P_256
...
java -cp \webpki.org\library\dist\webpki.org-libext-1.00.jar;\webpki.org\resources\third-party-jars\bcprov-jdk16-145.jar org.webpki.ca.CommandLineCA -ca/addpath all -ca/keypass testing -ca/storepass testing -ca/keystore subca.jks -entity/ee -subject " CN=secure.mybank.com, O=My Bank" -validity/start 2012-01-01T00:00:00 -validity/end 2020-07-10T09:59:59 -out/keystore mybank.jks -out/storepass testing -out/keypass testing  -sigalg RSA_SHA256 -keysize 2048
