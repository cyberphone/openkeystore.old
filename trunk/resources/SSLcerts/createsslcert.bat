...
java -cp ..\..\library\dist\webpki.org-libext-1.00.jar org.webpki.ca.CommandLineCA -ca/keystore sslrootca.jks -ca/storepass testing -ca/keypass theroot -entity/ee -subject "CN=%1, o=The Lab" -validity/start 2005-03-10T10:00:00 -validity/end 2015-03-10T09:59:59 -out/keystore %1.jks -out/storepass testing -out/keypass testing
