...
package org.webpki.org.apache.xerces.impl.dv;
...
public class DatatypeException extends Exception {
    ...
    public String getMessage() {
        ...
        resourceBundle = PropertyResourceBundle.getBundle("org.webpki.org.apache.xerces.impl.msg.XMLSchemaMessages");
        if (resourceBundle == null)
            throw new MissingResourceException("Property file not found!", "org.webpki.org.apache.xerces.impl.msg.XMLSchemaMessages", key);

        String msg = resourceBundle.getString(key);
        if (msg == null) {
            msg = resourceBundle.getString("BadMessageKey");
            throw new MissingResourceException(msg, "org.webpki.org.apache.xerces.impl.msg.XMLSchemaMessages", key);
        }
