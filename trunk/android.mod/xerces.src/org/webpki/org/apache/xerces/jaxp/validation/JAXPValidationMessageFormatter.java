...
final class JAXPValidationMessageFormatter {
    ...
    public static String formatMessage(Locale locale, 
        ...
        if (locale != null) {
            resourceBundle = 
                PropertyResourceBundle.getBundle("org.webpki.org.apache.xerces.impl.msg.JAXPValidationMessages", locale);
        }
        else {
            resourceBundle = 
                PropertyResourceBundle.getBundle("org.webpki.org.apache.xerces.impl.msg.JAXPValidationMessages");
        }
