...
public class CoreDOMImplementationImpl
	 ...
	 * At this writing, org.webpki.org.apache.xerces.dom supports only XML.
	 *
	    ...
	    if ((feature.equalsIgnoreCase("+XPath"))       
	        ...
	        try {
	            Class xpathClass = ObjectFactory.findProviderClass(
	                "org.webpki.org.apache.xpath.domapi.XPathEvaluatorImpl",
    ...
    public LSParser createLSParser(short mode, String schemaType)
		...
		if (schemaType != null
			...
			return new DOMParserImpl(
				"org.webpki.org.apache.xerces.parsers.DTDConfiguration",
				schemaType);
		}
		else {
    ...
    public LSSerializer createLSSerializer() {
        try {
            Class serializerClass = ObjectFactory.findProviderClass(
                "org.webpki.org.apache.xml.serializer.dom3.LSSerializerImpl",
                ObjectFactory.findClassLoader(), true);
	...
	synchronized RevalidationHandler getValidator(String schemaType, String xmlVersion) {
        if (schemaType == XMLGrammarDescription.XML_SCHEMA) {
            ...
            return (RevalidationHandler) (ObjectFactory
                    .newInstance(
                        "org.webpki.org.apache.xerces.impl.xs.XMLSchemaValidator",
            ...
            if ("1.1".equals(xmlVersion)) {
                ...
                return (RevalidationHandler) (ObjectFactory
                        .newInstance(
                                "org.webpki.org.apache.xerces.impl.dtd.XML11DTDValidator",
                                ObjectFactory.findClassLoader(),
                                true));
            }
            // return an instance of XMLDTDValidator
                ...
                return (RevalidationHandler) (ObjectFactory
                        .newInstance(
                            "org.webpki.org.apache.xerces.impl.dtd.XMLDTDValidator",
                            ObjectFactory.findClassLoader(),
                            true));
            }
        }
    ...
    synchronized final XMLDTDLoader getDTDLoader(String xmlVersion) {
        ...
        if ("1.1".equals(xmlVersion)) {
            ...
            return (XMLDTDLoader) (ObjectFactory
                    .newInstance(
                        "org.webpki.org.apache.xerces.impl.dtd.XML11DTDProcessor",
                        ObjectFactory.findClassLoader(),
                        true));
        }
