...
import org.webpki.org.apache.xerces.jaxp.datatype.DatatypeFactoryImpl;
import org.webpki.org.apache.xerces.xs.datatypes.XSDateTime;
...
public abstract class AbstractDateTimeDV extends TypeValidator {
	...
	static final class DateTimeData implements XSDateTime {
		...
		/* (non-Javadoc)
		 * @see org.webpki.org.apache.xerces.xs.datatypes.XSDateTime#getYear()
		 */
		public int getYears() {
		...
		/* (non-Javadoc)
		 * @see org.webpki.org.apache.xerces.xs.datatypes.XSDateTime#getMonth()
		 */
		...
		/* (non-Javadoc)
		 * @see org.webpki.org.apache.xerces.xs.datatypes.XSDateTime#getDay()
		 */
		public int getDays() {
            if(type instanceof DurationDV)
                return 0;
		...
		/* (non-Javadoc)
		 * @see org.webpki.org.apache.xerces.xs.datatypes.XSDateTime#getHour()
		 */
		public int getHours() {
            if(type instanceof DurationDV)
                return 0;
		...
		/* (non-Javadoc)
		 * @see org.webpki.org.apache.xerces.xs.datatypes.XSDateTime#getMinutes()
		 */
		...
		/* (non-Javadoc)
		 * @see org.webpki.org.apache.xerces.xs.datatypes.XSDateTime#getSeconds()
		 */
		...
		/* (non-Javadoc)
		 * @see org.webpki.org.apache.xerces.xs.datatypes.XSDateTime#hasTimeZone()
		 */
		public boolean hasTimeZone() {
			return utc != 0;
		}
		/* (non-Javadoc)
		 * @see org.webpki.org.apache.xerces.xs.datatypes.XSDateTime#getTimeZoneHours()
		 */
		public int getTimeZoneHours() {
			return timezoneHr;
		}
		/* (non-Javadoc)
		 * @see org.webpki.org.apache.xerces.xs.datatypes.XSDateTime#getTimeZoneMinutes()
		 */
		public int getTimeZoneMinutes() {
			return timezoneMin;
		}
        /* (non-Javadoc)
         * @see org.webpki.org.apache.xerces.xs.datatypes.XSDateTime#getLexicalValue()
         */
        public String getLexicalValue() {
            return originalValue;
        }
        /* (non-Javadoc)
         * @see org.webpki.org.apache.xerces.xs.datatypes.XSDateTime#normalize()
         */
        ...
        /* (non-Javadoc)
         * @see org.webpki.org.apache.xerces.xs.datatypes.XSDateTime#isNormalized()
         */
        ...
        /* (non-Javadoc)
         * @see org.webpki.org.apache.xerces.xs.datatypes.XSDateTime#getXMLGregorianCalendar()
         */
        public XMLGregorianCalendar getXMLGregorianCalendar() {
            return type.getXMLGregorianCalendar(this);
        }
        /* (non-Javadoc)
         * @see org.webpki.org.apache.xerces.xs.datatypes.XSDateTime#getDuration()
         */
