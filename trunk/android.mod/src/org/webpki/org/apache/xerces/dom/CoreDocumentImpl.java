...
extends ParentNode implements Document  {
    ...
    public String getBaseURI() {
        if (fDocumentURI != null && fDocumentURI.length() != 0 ) {// attribute value is always empty string
            ...
            catch (org.webpki.org.apache.xerces.util.URI.MalformedURIException e){
    ...
    public Node adoptNode(Node source) {
        ...
        if (source == null ) {
            ...
            if (thisImpl != otherImpl) {
                ...
                if (thisImpl instanceof org.webpki.org.apache.xerces.dom.DOMImplementationImpl &&
                        otherImpl instanceof org.webpki.org.apache.xerces.dom.DeferredDOMImplementationImpl) {
                    // traverse the DOM and expand deffered nodes and then allow adoption
                    undeferChildren (node);
                } else if ( thisImpl instanceof org.webpki.org.apache.xerces.dom.DeferredDOMImplementationImpl
                        && otherImpl instanceof org.webpki.org.apache.xerces.dom.DOMImplementationImpl) {
