...
//      System.out.println ("f=" + ofile.toString());
    ...
    JAXWSFixer (String server_interface, String client_interface, String gen_directory) throws Exception {
    ...
    static public void main (String[] args) throws Exception{
        if (args.length != 3 && args.length != 2){
            System.out.println (JAXWSFixer.class.getName() + " WS-server-interface-file  WS-generated-client-interface-file jdoc-\"gen\"-dir\n" +
                                JAXWSFixer.class.getName() + " WS-hand-written-file WS-generated-file\n\n" +
                                "Generate JDoc\nCompare Declarations\n");
            System.exit(2);
        }
        new JAXWSFixer (args[0], args[1], args.length == 3 ? args[2] : null);
    }
