        ...
        try
          {
            ...
            stmt.setBytes (5, KeyUtil.getEncryptedPassphrase (puk_code, puk_format));
            stmt.execute ();
        ...
        try
          {
            ...
            stmt.setInt (3, PINGrouping.SHARED.ordinal ());
            stmt.setInt (4, key_id);
            stmt.setBytes (5, KeyUtil.getEncryptedPassphrase (old_pin, pin_format));
            stmt.setBytes (6, KeyUtil.getEncryptedPassphrase (new_pin, pin_format));
            stmt.execute ();
            int status = stmt.getInt (1);
            int value = stmt.getInt (2);
            stmt.close ();
