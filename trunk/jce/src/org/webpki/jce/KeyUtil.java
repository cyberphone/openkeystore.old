...
public class KeyUtil
  {
    public static KeyStoreDatabaseConnection key_store_database_connection;
    ...
    static byte[] getEncryptedPassphrase (String passphrase, PassphraseFormats format) throws IOException
      {
        return CryptoDriver.scramblePassword (format == PassphraseFormats.HEX2BYTES ?
    ...
    public static Connection getDatabaseConnection () throws SQLException
      {
        return key_store_database_connection.getDatabaseConnection ();
      }
