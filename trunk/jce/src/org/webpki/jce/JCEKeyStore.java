...
public class JCEKeyStore extends KeyStoreSpi
  {
    ...
    class JCEPrivateKey extends UniversalKeyStore implements PrivateKey
      {
        KeyDescriptor kd;
        ...
        JCEPrivateKey (KeyDescriptor kd, int user_id, char[] password)
          {
            super (user_id);
            this.kd = kd;
    ...
    class JCESecretKey extends UniversalKeyStore implements SecretKey
      {
        KeyDescriptor kd;
        int user_id;
        ...
        JCESecretKey (KeyDescriptor kd, int user_id, char[] password)
          {
            super (user_id);
            this.kd = kd;
    ...
    public Key engineGetKey (String alias, char[] password) throws UnrecoverableKeyException
      {
        ...
        if (kd.isAsymmetric ())
          {
            return new JCEPrivateKey (kd, user_id, password);
          }
        return new JCESecretKey (kd, user_id, password);
      }
    ...
    public void engineLoad (InputStream stream, char[] password) throws IOException
      {
        ...
        user_id = getInt (password);
        kds = new KeyMetadataProvider (user_id).getKeyDescriptors ();
      }
