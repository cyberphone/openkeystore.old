...
import org.webpki.sksimpl.dbemulator.DatabaseService;
...
public class KeyUtil
  {
    ...
    static byte[] getPassphrase (String passphrase, PassphraseFormat format) throws IOException
      {
        return format == PassphraseFormat.BINARY ?
