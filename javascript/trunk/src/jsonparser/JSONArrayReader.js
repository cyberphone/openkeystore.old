...
/* Object */JSONArrayReader.prototype._get = function (/* JSONTypes */expected_type)
{
    ...
    {
        JSONObject.prototype.bad ("Incompatible request: " + "Read=" + JSONValue.prototype.getJSONTypeName (value.type) + ", Expected="
                + JSONValue.prototype.getJSONTypeName (expected_type));
    }
    return value.value;
};
