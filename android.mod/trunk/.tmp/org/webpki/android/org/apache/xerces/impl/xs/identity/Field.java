...
import org.webpki.android.org.apache.xerces.impl.xpath.XPathException;
...
public class Field {
    ...
    public org.webpki.android.org.apache.xerces.impl.xpath.XPath getXPath() {
        return fXPath;
    } // getXPath():org.webpki.android.org.apache.xerces.impl.v1.schema.identity.XPath
    ...
    public static class XPath
        extends org.webpki.android.org.apache.xerces.impl.xpath.XPath {
        ...
        public XPath(String xpath, 
            ...
            for (int i=0;i<fLocationPaths.length;i++) {
                for(int j=0; j<fLocationPaths[i].steps.length; j++) {
                    org.webpki.android.org.apache.xerces.impl.xpath.XPath.Axis axis =
