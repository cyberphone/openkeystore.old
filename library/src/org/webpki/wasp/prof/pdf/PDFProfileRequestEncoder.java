...
public class PDFProfileRequestEncoder extends XMLObjectWrapper implements SignatureProfileEncoder {
    ...
    AsymSignatureAlgorithms signatureAlgorithm = AsymSignatureAlgorithms.RSA_SHA1;
    ...
    protected void toXML(DOMWriterHelper wr) throws IOException {
        ...
        if (signatureAlgorithm != AsymSignatureAlgorithms.RSA_SHA1) {
