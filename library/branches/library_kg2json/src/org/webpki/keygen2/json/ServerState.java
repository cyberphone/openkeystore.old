    ...
    public abstract class ExtensionInterface implements Serializable
      {
        ...
        abstract void writeExtension (JSONWriter wr, byte[] mac_data) throws IOException;
        
        void writeCore (JSONWriter wr, byte[] mac_data) throws IOException
          {
    ...
    public class Extension extends ExtensionInterface implements Serializable
      {
        ...
        void writeExtension (JSONWriter wr, byte[] mac_data) throws IOException
          {
            ...
            for (Property property : properties.values ())
              {
                ...
                wr.setString (NAME_JSON, property.name);
                wr.setString (VALUE_JSON, property.value);
                if (property.writable)
                  {
                    wr.setBoolean (WRITABLE_JSON, property.writable);
                  }
                wr.getParent ();
              }
            wr.getParent ();
    ...
    class PresetValue implements Serializable
      {
        ...
        void write (JSONWriter wr) throws IOException
          {
    ...
    public class PUKPolicy extends PresetValue implements Serializable
      {
        ...
        void writePolicy (JSONWriter wr) throws IOException, GeneralSecurityException
          {
            wr.addElement (PUK_POLICY_JSON);
    ...
    public class Key implements Serializable
      {
        ...
        void writeRequest (JSONWriter wr) throws IOException, GeneralSecurityException
          {
            key_init_done = true;
            ...
            if (device_pin_protection)
              {
                wr.addElement (DEVICE_PIN_PROTECTION_JSON);
              }
            if (preset_pin != null)
              {
                wr.addElement (PRESET_PIN_JSON);
                preset_pin.write (wr);
              }
            wr.addElement (KEY_ENTRY_JSON);
            wr.setString (ID_JSON, id);
