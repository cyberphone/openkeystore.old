...
public class JavaScriptSignatureServlet extends HttpServlet
  {
    ...
    void showSignature (HttpServletRequest request, HttpServletResponse response, byte[] signed_json) throws IOException, ServletException
      {
        ...
        HTML.printResultPage (response,
            ...
            "<tr><td align=\"center\" style=\"font-weight:bolder;font-size:10pt;font-family:arial,verdana\">Signed JavaScript Object<br>&nbsp;</td></tr>" +
             ...
             "<tr><td align=\"left\"><pre>" + HTML.fancyBox ("verify", 
                                                       new String (new JSONObjectWriter (parsed_json).serializeJSONObject (JSONOutputFormats.PRETTY_JS_NATIVE), "UTF-8")) +
            "</pre></td></tr>" +
            "</table>");
      }
